...
require('../css/leaflet-gplaces-autocomplete.css')
...
GPlaceAutocomplete = function (options) {
    return new L.Control.GPlaceAutocomplete(options);
};

module.exports = GPlaceAutocomplete